<%-- 
    Document   : index
    Created on : 9/07/2019, 04:01:50 PM
    Author     : abiga
--%>
...
<%@page import="mx.com.develop.services.PartidosService"%>
<% 
    PartidosService servicioPartidos = new PartidosService();
    Map<String,List<List<String>>> partidos = servicioPartidos.getHorariosPartidos();
    
    List<Equipo> posiciones = new MbdEquipos().obtenerPosiciones();
    int lugar =0;
%>
<!doctype html>
<html lang="en">
        ...
        <div class="tab-pane fade active in" id="matches">
          ...
          <div class="tab-pane fade active in" id="seniors-matches">
            ...
            <div class="upcoming col-lg-6 col-lg-offset-0 col-md-8 col-md-offset-2 col-sm-10 col-sm-offset-1 clearfix">
              <h4 class="border">Últimos Resultados</h4>
              <ul class="matches custom-list">
                  <%for(List partido : partidos.get("jugados")){
                 %>
                <li class="match">
                  <div class="team text-left">
                  <img src="<%=partido.get(0)%>" alt=""><span><%=partido.get(1)%></span>
                  </div>
                  <div class="marcador">
					<div class="marcador_izquierda"><p><%=partido.get(2)%></p></div>
					<div class="marcador_centro"><p>:</p></div>
					<div class="marcador_derecha"><p><%=partido.get(3)%></p></div>
                  </div>
                  <div class="team right text-right">
                    <span><%=partido.get(4)%></span>
                    <img src="<%=partido.get(5)%>" alt="">
                  </div>
                </li>
                <%}%> 
            ...
            <div class="upcoming col-lg-6 col-lg-offset-0 col-md-8 col-md-offset-2 col-sm-10 col-sm-offset-1 clearfix">
              ...
              <ul class="matches custom-list">
                   <%for(List partido : partidos.get("pendientes")){
                 %>
                <li class="match">
                  <div class="team text-left">
                  <img src="<%=partido.get(0)%>" alt=""><span><%=partido.get(1)%></span>
                  ...
                  <div class="schedule">
                    <span class="team-name">HORARIO</span>
                    <span class="time"><%=partido.get(6)%></span>
                  </div>
                  <div class="team right text-right">
                    <span><%=partido.get(4)%></span>
                    <img src="<%=partido.get(5)%>" alt="">
        ...
        <div class="tab-pane fade" id="trainings">
          ...
          <div class="tab-pane fade active in" id="seniors-trainings">
            <div class="training-header col-lg-12 col-md-12 col-sm-12">
              <h4 class="border pull-left">Posiciones de los equipos</h4>
            ...
            <div class="training-table col-lg-12 col-md-12 col-xs-12">
              <header>
                ...
                <h5>Tabla de posiciones Julio 2019</h5>
                <a href="#" class="button next pull-right"><span>Siguiente</span><i class="fa fa-arrow-circle-right"></i></a>
              </header>
              <table class="table">
                  <thead>
                    <tr>
                      <td class="col-lg-1 col-md-1 col-xs-1 text-center"><strong>Lugar</strong></td>
                      <td class="col-lg-2 col-md-2 col-xs-2 text-center"><strong>Equipo</strong></td>
                      <td class="col-lg-1 col-md-1 col-xs-1 text-center"><strong>#</strong></td>
                      <td class="col-lg-1 col-md-1 col-xs-1 text-center"><strong>Puntos</strong></td>
                      <td class="col-lg-1 col-md-1 col-xs-1 text-center"><strong>Puntos a favor</strong></td>
                      <td class="col-lg-2 col-md-2 col-xs-2 text-center"><strong>Puntos en contra</strong></td>
                      <td class="col-lg-2 col-md-2 col-xs-2 text-center"><strong>Diferencia de puntos</strong></td>
                      <td class="col-lg-2 col-md-2 col-xs-2 text-center"><strong>Perdidos por default</strong></td>
                    </tr>
                </thead>
                    <%for(Equipo equipo : posiciones){ %>
                <tr>
                    <td class="col-lg-1 col-md-1 col-xs-1 text-center"><%=++lugar%></td>
                    <td class="col-lg-2 col-md-2 col-xs-2 text-center"><%=equipo.getNombre()%></td>
                    <td class="col-lg-1 col-md-1 col-xs-1 text-center"><%=equipo.getIdEquipo()%></td>
                    <td class="col-lg-1 col-md-1 col-xs-1 text-center"><%=equipo.getPuntos()%></td>
                    <td class="col-lg-1 col-md-1 col-xs-1 text-center"><%=equipo.getPuntosFavor()%></td>
                    <td class="col-lg-2 col-md-2 col-xs-2 text-center"><%=equipo.getPuntosContra()%></td>
                    <td class="col-lg-2 col-md-2 col-xs-2 text-center"><%=(equipo.getPuntosFavor()-equipo.getPuntosContra())%></td>
                    <td class="col-lg-2 col-md-2 col-xs-2 text-center"><%=equipo.getPerdidosDefault()%></td>
                </tr>
                <%}%> 
              </table>
              <footer>
